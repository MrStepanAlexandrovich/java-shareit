...
public class ItemDtoJsonTest {
    ...
    void testSerialize() throws Exception {
        ...
        assertThat(result).extractingJsonPathNumberValue("$.request").isEqualTo(3);
        assertThat(result).extractingJsonPathArrayValue("$.comments").hasSize(1);
    }

    @Test
    void testDeserialize() throws Exception {
        String content = "{\"id\":1,\"name\":\"Drill\",\"description\":\"Electric drill\",\"available\":true,\"owner\":2,\"request\":3}";
        ...
        assertThat(dto.getRequest()).isEqualTo(3);
    }
}
